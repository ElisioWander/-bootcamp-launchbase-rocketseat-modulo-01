...
const Lightbox = {
    target: document.querySelector('.ligthbox-target'),
    image: document.querySelector('.ligthbox-target img'),
    closeButton: document.querySelector('.ligthbox-target a.lightbox-close'),
    open() {
